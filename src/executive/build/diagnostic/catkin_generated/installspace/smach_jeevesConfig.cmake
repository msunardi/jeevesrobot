...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'smach_jeeves' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sr/catkin_make/roboticsclub-mcecsbot/src/executive/install/${idir}'.  Ask the maintainer 'sr <sr@todo.todo>' to fix it.")
    endif()
