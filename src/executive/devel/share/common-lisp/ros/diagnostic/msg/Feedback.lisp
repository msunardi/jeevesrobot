...
(cl:defmethod cl:initialize-instance :after ((m <Feedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Feedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name diagnostic-msg:<Feedback> is deprecated: use diagnostic-msg:Feedback instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Feedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader diagnostic-msg:header-val is deprecated.  Use diagnostic-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'motor_current-val :lambda-list '(m))
(cl:defmethod motor_current-val ((m <Feedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader diagnostic-msg:motor_current-val is deprecated.  Use diagnostic-msg:motor_current instead.")
  (motor_current m))

(cl:ensure-generic-function 'motor_power-val :lambda-list '(m))
(cl:defmethod motor_power-val ((m <Feedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader diagnostic-msg:motor_power-val is deprecated.  Use diagnostic-msg:motor_power instead.")
  (motor_power m))

(cl:ensure-generic-function 'commanded_velocity-val :lambda-list '(m))
(cl:defmethod commanded_velocity-val ((m <Feedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader diagnostic-msg:commanded_velocity-val is deprecated.  Use diagnostic-msg:commanded_velocity instead.")
...
(cl:defmethod measured_velocity-val ((m <Feedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader diagnostic-msg:measured_velocity-val is deprecated.  Use diagnostic-msg:measured_velocity instead.")
  (measured_velocity m))

(cl:ensure-generic-function 'measured_position-val :lambda-list '(m))
(cl:defmethod measured_position-val ((m <Feedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader diagnostic-msg:measured_position-val is deprecated.  Use diagnostic-msg:measured_position instead.")
  (measured_position m))

(cl:ensure-generic-function 'supply_voltage-val :lambda-list '(m))
(cl:defmethod supply_voltage-val ((m <Feedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader diagnostic-msg:supply_voltage-val is deprecated.  Use diagnostic-msg:supply_voltage instead.")
  (supply_voltage m))

(cl:ensure-generic-function 'supply_current-val :lambda-list '(m))
(cl:defmethod supply_current-val ((m <Feedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader diagnostic-msg:supply_current-val is deprecated.  Use diagnostic-msg:supply_current instead.")
  (supply_current m))

(cl:ensure-generic-function 'motor_temperature-val :lambda-list '(m))
(cl:defmethod motor_temperature-val ((m <Feedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader diagnostic-msg:motor_temperature-val is deprecated.  Use diagnostic-msg:motor_temperature instead.")
  (motor_temperature m))

(cl:ensure-generic-function 'channel_temperature-val :lambda-list '(m))
(cl:defmethod channel_temperature-val ((m <Feedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader diagnostic-msg:channel_temperature-val is deprecated.  Use diagnostic-msg:channel_temperature instead.")
