// Generated by gencpp from file diagnostic/Status.msg
// DO NOT EDIT!


#ifndef DIAGNOSTIC_MESSAGE_STATUS_H
#define DIAGNOSTIC_MESSAGE_STATUS_H
...
struct Status_
{
  ...
  typedef boost::shared_ptr< ::diagnostic::Status_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::diagnostic::Status_<ContainerAllocator> const> ConstPtr;

}; // struct Status_

typedef ::diagnostic::Status_<std::allocator<void> > Status;

typedef boost::shared_ptr< ::diagnostic::Status > StatusPtr;
typedef boost::shared_ptr< ::diagnostic::Status const> StatusConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::diagnostic::Status_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::diagnostic::Status_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::diagnostic::Status_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::diagnostic::Status_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::diagnostic::Status_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::diagnostic::Status_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::diagnostic::Status_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::diagnostic::Status_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::diagnostic::Status_<ContainerAllocator> >
{
  ...
  static const char* value(const ::diagnostic::Status_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xd3a9b223fdfb0968ULL;
  static const uint64_t static_value2 = 0x255e25e5a859ac29ULL;
};

template<class ContainerAllocator>
struct DataType< ::diagnostic::Status_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::diagnostic::Status_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::diagnostic::Status_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::diagnostic::Status_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::diagnostic::Status_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // DIAGNOSTIC_MESSAGE_STATUS_H
