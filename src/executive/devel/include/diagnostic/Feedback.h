// Generated by gencpp from file diagnostic/Feedback.msg
// DO NOT EDIT!


#ifndef DIAGNOSTIC_MESSAGE_FEEDBACK_H
#define DIAGNOSTIC_MESSAGE_FEEDBACK_H
...
struct Feedback_
{
  ...
  typedef boost::shared_ptr< ::diagnostic::Feedback_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::diagnostic::Feedback_<ContainerAllocator> const> ConstPtr;

}; // struct Feedback_

typedef ::diagnostic::Feedback_<std::allocator<void> > Feedback;

typedef boost::shared_ptr< ::diagnostic::Feedback > FeedbackPtr;
typedef boost::shared_ptr< ::diagnostic::Feedback const> FeedbackConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::diagnostic::Feedback_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::diagnostic::Feedback_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::diagnostic::Feedback_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::diagnostic::Feedback_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::diagnostic::Feedback_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::diagnostic::Feedback_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::diagnostic::Feedback_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::diagnostic::Feedback_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::diagnostic::Feedback_<ContainerAllocator> >
{
  ...
  static const char* value(const ::diagnostic::Feedback_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x2b31653367731d62ULL;
  static const uint64_t static_value2 = 0x54182bb2f9dbb81aULL;
};

template<class ContainerAllocator>
struct DataType< ::diagnostic::Feedback_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::diagnostic::Feedback_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::diagnostic::Feedback_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::diagnostic::Feedback_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::diagnostic::Feedback_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // DIAGNOSTIC_MESSAGE_FEEDBACK_H
