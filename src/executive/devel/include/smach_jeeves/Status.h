// Generated by gencpp from file smach_jeeves/Status.msg
// DO NOT EDIT!


#ifndef SMACH_JEEVES_MESSAGE_STATUS_H
#define SMACH_JEEVES_MESSAGE_STATUS_H
...
struct Status_
{
  ...
  typedef boost::shared_ptr< ::smach_jeeves::Status_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::smach_jeeves::Status_<ContainerAllocator> const> ConstPtr;

}; // struct Status_

typedef ::smach_jeeves::Status_<std::allocator<void> > Status;

typedef boost::shared_ptr< ::smach_jeeves::Status > StatusPtr;
typedef boost::shared_ptr< ::smach_jeeves::Status const> StatusConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::smach_jeeves::Status_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::smach_jeeves::Status_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::smach_jeeves::Status_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::smach_jeeves::Status_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::smach_jeeves::Status_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::smach_jeeves::Status_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::smach_jeeves::Status_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::smach_jeeves::Status_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::smach_jeeves::Status_<ContainerAllocator> >
{
  ...
  static const char* value(const ::smach_jeeves::Status_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xd3a9b223fdfb0968ULL;
  static const uint64_t static_value2 = 0x255e25e5a859ac29ULL;
};

template<class ContainerAllocator>
struct DataType< ::smach_jeeves::Status_<ContainerAllocator> >
{
  static const char* value()
  {
    return "smach_jeeves/Status";
  }
...
template<class ContainerAllocator>
struct Definition< ::smach_jeeves::Status_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::smach_jeeves::Status_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::smach_jeeves::Status_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::smach_jeeves::Status_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // SMACH_JEEVES_MESSAGE_STATUS_H
