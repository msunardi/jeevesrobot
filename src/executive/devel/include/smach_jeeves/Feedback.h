// Generated by gencpp from file smach_jeeves/Feedback.msg
// DO NOT EDIT!


#ifndef SMACH_JEEVES_MESSAGE_FEEDBACK_H
#define SMACH_JEEVES_MESSAGE_FEEDBACK_H
...
struct Feedback_
{
  ...
  typedef boost::shared_ptr< ::smach_jeeves::Feedback_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::smach_jeeves::Feedback_<ContainerAllocator> const> ConstPtr;

}; // struct Feedback_

typedef ::smach_jeeves::Feedback_<std::allocator<void> > Feedback;

typedef boost::shared_ptr< ::smach_jeeves::Feedback > FeedbackPtr;
typedef boost::shared_ptr< ::smach_jeeves::Feedback const> FeedbackConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::smach_jeeves::Feedback_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::smach_jeeves::Feedback_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::smach_jeeves::Feedback_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::smach_jeeves::Feedback_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::smach_jeeves::Feedback_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::smach_jeeves::Feedback_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::smach_jeeves::Feedback_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::smach_jeeves::Feedback_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::smach_jeeves::Feedback_<ContainerAllocator> >
{
  ...
  static const char* value(const ::smach_jeeves::Feedback_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x2b31653367731d62ULL;
  static const uint64_t static_value2 = 0x54182bb2f9dbb81aULL;
};

template<class ContainerAllocator>
struct DataType< ::smach_jeeves::Feedback_<ContainerAllocator> >
{
  static const char* value()
  {
    return "smach_jeeves/Feedback";
  }
...
template<class ContainerAllocator>
struct Definition< ::smach_jeeves::Feedback_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::smach_jeeves::Feedback_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::smach_jeeves::Feedback_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::smach_jeeves::Feedback_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // SMACH_JEEVES_MESSAGE_FEEDBACK_H
