// Generated by gencpp from file diagnostics/Status.msg
// DO NOT EDIT!


#ifndef DIAGNOSTICS_MESSAGE_STATUS_H
#define DIAGNOSTICS_MESSAGE_STATUS_H
...
struct Status_
{
  ...
  typedef boost::shared_ptr< ::diagnostics::Status_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::diagnostics::Status_<ContainerAllocator> const> ConstPtr;

}; // struct Status_

typedef ::diagnostics::Status_<std::allocator<void> > Status;

typedef boost::shared_ptr< ::diagnostics::Status > StatusPtr;
typedef boost::shared_ptr< ::diagnostics::Status const> StatusConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::diagnostics::Status_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::diagnostics::Status_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::diagnostics::Status_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::diagnostics::Status_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::diagnostics::Status_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::diagnostics::Status_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::diagnostics::Status_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::diagnostics::Status_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::diagnostics::Status_<ContainerAllocator> >
{
  ...
  static const char* value(const ::diagnostics::Status_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xd3a9b223fdfb0968ULL;
  static const uint64_t static_value2 = 0x255e25e5a859ac29ULL;
};

template<class ContainerAllocator>
struct DataType< ::diagnostics::Status_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::diagnostics::Status_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::diagnostics::Status_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::diagnostics::Status_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::diagnostics::Status_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // DIAGNOSTICS_MESSAGE_STATUS_H
