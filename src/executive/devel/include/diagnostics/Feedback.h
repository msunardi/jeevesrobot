// Generated by gencpp from file diagnostics/Feedback.msg
// DO NOT EDIT!


#ifndef DIAGNOSTICS_MESSAGE_FEEDBACK_H
#define DIAGNOSTICS_MESSAGE_FEEDBACK_H
...
struct Feedback_
{
  ...
  typedef boost::shared_ptr< ::diagnostics::Feedback_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::diagnostics::Feedback_<ContainerAllocator> const> ConstPtr;

}; // struct Feedback_

typedef ::diagnostics::Feedback_<std::allocator<void> > Feedback;

typedef boost::shared_ptr< ::diagnostics::Feedback > FeedbackPtr;
typedef boost::shared_ptr< ::diagnostics::Feedback const> FeedbackConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::diagnostics::Feedback_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::diagnostics::Feedback_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::diagnostics::Feedback_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::diagnostics::Feedback_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::diagnostics::Feedback_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::diagnostics::Feedback_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::diagnostics::Feedback_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::diagnostics::Feedback_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::diagnostics::Feedback_<ContainerAllocator> >
{
  ...
  static const char* value(const ::diagnostics::Feedback_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x2b31653367731d62ULL;
  static const uint64_t static_value2 = 0x54182bb2f9dbb81aULL;
};

template<class ContainerAllocator>
struct DataType< ::diagnostics::Feedback_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::diagnostics::Feedback_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::diagnostics::Feedback_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::diagnostics::Feedback_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::diagnostics::Feedback_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // DIAGNOSTICS_MESSAGE_FEEDBACK_H
