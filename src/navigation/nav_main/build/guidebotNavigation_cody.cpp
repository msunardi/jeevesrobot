...
static string TTY_PORT       =     "/dev/ttyACM4";
...
static char* LRF_PORT_NAME		=	"/dev/ttyACM4";
static char* ODO_PORT_NAME		=	"/dev/ttyACM4";
static char* MOTOR_PORT_NAME		=	"/dev/ttyACM4";
...
int main(int argc, char **argv)
{
	try
	{
		...
		TTY_PORT       =     guidebotConfFile.read_string("NavigationParams","TTY_PORT","/dev/ttyACM4", true);
